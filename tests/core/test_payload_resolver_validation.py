...
def test_validate_tool_inputs_missing_required() -> None:
    ...
    tool_inputs = {"docx_render_from_spec": {"path": "documents/out.docx"}}

    errors = validate_tool_inputs(tool_inputs, schemas)

    assert "docx_render_from_spec" in errors
    assert "document_spec" in errors["docx_render_from_spec"]
...
def test_validate_tool_inputs_ok() -> None:
    ...
    tool_inputs = {"docx_render_from_spec": {"path": "documents/out.docx", "document_spec": {}}}
